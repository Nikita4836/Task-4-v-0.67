...
import com.company.CheckInputType;
import com.company.CheckRead;
    ...
    public static double[] toDoubleArray(String str) {
        ...
        while (scanner.hasNext()) {
            if (!scanner.hasNextDouble()) {
                System.out.println("Ошибка в записи в файл, повторите ввод");
                return null;
            }
        ...
        // Double[] -> double[]
        if (arr.length == 0) {
            System.out.println("Вы не ввели точек, повторите ввод");
        }
        return ArrayUtils.toPrimitive(arr);
    }
